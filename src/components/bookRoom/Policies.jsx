    ...
    <div className='mx-2 mt-6 md:w-1/2 h-full'>
      ...
      <ul className='grid grid-rows-2 grid-cols-1 md:grid-cols-2 md:gap-2 md:text-sm '>
        <li>
          ...
          <p className='ml-8  text-gray-600'>Check-out from 11:00 AM until 12:00 PM</p>
        </li>
        <li>
          
          <h3 className='font-bold '><span> <PetsIcon className=' text-gray-800'/></span> Pets </h3>
          <p className='ml-8  text-gray-600'>Pets are not allowed</p>
        </li>
        <li>
        
          <h3 className='font-bold '> <span> <PaidIcon className=' text-gray-800'/> </span>Accepted payments methods</h3>
          <p className='ml-8  text-gray-600'>Card only</p>
        </li>
      </ul>
    </div>
  )
